...
namespace NetModular.Lib.Data.Abstractions.SqlQueryable
{
    public interface INetSqlQueryable<TEntity, TEntity2> : INetSqlQueryable where TEntity : IEntity, new() where TEntity2 : IEntity, new()
    {
        ...
        /// <returns></returns>
        INetSqlQueryable<TEntity, TEntity2> UseUow(IUnitOfWork uow);
        ...
        /// 过滤
        /// </summary>
        /// <param name="whereSql">过滤条件，原生SQL语句</param>
        /// <returns></returns>
        INetSqlQueryable<TEntity, TEntity2> Where(string whereSql);
        ...
        /// <returns></returns>
        INetSqlQueryable<TEntity, TEntity2> WhereIf(bool condition, string whereSql);
        ...
        /// <returns></returns>
        INetSqlQueryable<TEntity, TEntity2> WhereIf(bool condition, string ifWhereSql, string elseWhereSql);
        ...
        /// <returns></returns>
        INetSqlQueryable<TEntity, TEntity2> WhereNotNull(string condition, string whereSql);
        ...
        /// <param name="elseWhereSql"></param>
        /// <returns></returns>
        INetSqlQueryable<TEntity, TEntity2> WhereNotNull(string condition, string ifWhereSql, string elseWhereSql);
        ...
        /// <param name="expression"></param>
        /// <returns></returns>
        INetSqlQueryable<TEntity, TEntity2> WhereNotNull(object condition, Expression<Func<TEntity, TEntity2, bool>> expression);
        ...
        /// <param name="whereSql"></param>
        /// <returns></returns>
        INetSqlQueryable<TEntity, TEntity2> WhereNotNull(object condition, string whereSql);
        ...
        /// <param name="elseExpression"></param>
        /// <returns></returns>
        INetSqlQueryable<TEntity, TEntity2> WhereNotNull(object condition, Expression<Func<TEntity, TEntity2, bool>> ifExpression, Expression<Func<TEntity, TEntity2, bool>> elseExpression);
        ...
        /// <param name="elseWhereSql"></param>
        /// <returns></returns>
        INetSqlQueryable<TEntity, TEntity2> WhereNotNull(object condition, string ifWhereSql, string elseWhereSql);
        ...
        /// <param name="whereSql"></param>
        /// <returns></returns>
        INetSqlQueryable<TEntity, TEntity2> WhereNotEmpty(Guid condition, string whereSql);
        ...
        /// <param name="elseWhereSql"></param>
        /// <returns></returns>
        INetSqlQueryable<TEntity, TEntity2> WhereNotEmpty(Guid condition, string ifWhereSql, string elseWhereSql);
        ...
        /// <returns></returns>
        INetSqlQueryable<TEntity, TEntity2> WhereNotIn<TKey>(Expression<Func<TEntity, TEntity2, TKey>> key, IEnumerable<TKey> list);
        ...
        /// <returns></returns>
        INetSqlQueryable<TEntity, TEntity2> Where<TKey>(Expression<Func<TEntity, TEntity2, TKey>> key, QueryOperator queryOperator, INetSqlQueryable queryable);
        ...
        /// <param name="expression"></param>
        /// <returns></returns>
        INetSqlQueryable<TEntity, TEntity2> SelectExclude<TResult>(Expression<Func<TEntity, TEntity2, TResult>> expression);
        ...
        /// <returns></returns>
        INetSqlQueryable<TEntity, TEntity2, TEntity3> LeftJoin<TEntity3>(Expression<Func<TEntity, TEntity2, TEntity3, bool>> onExpression, string tableName = null, bool noLock = true) where TEntity3 : IEntity, new();
        ...
        /// <param name="noLock">针对SqlServer的NoLock特性，默认开启</param>
        /// <returns></returns>
        INetSqlQueryable<TEntity, TEntity2, TEntity3> InnerJoin<TEntity3>(Expression<Func<TEntity, TEntity2, TEntity3, bool>> onExpression, string tableName = null, bool noLock = true) where TEntity3 : IEntity, new();
        ...
        /// <param name="noLock">针对SqlServer的NoLock特性，默认开启</param>
        /// <returns></returns>
        INetSqlQueryable<TEntity, TEntity2, TEntity3> RightJoin<TEntity3>(Expression<Func<TEntity, TEntity2, TEntity3, bool>> onExpression, string tableName = null, bool noLock = true) where TEntity3 : IEntity, new();
        ...
        /// </summary>
        /// <returns></returns>
        IGroupByQueryable2<INetSqlGroupingKey2<TEntity, TEntity2>, TEntity, TEntity2> GroupBy();
        ...
        /// </summary>
        /// <returns></returns>
        INetSqlQueryable<TEntity, TEntity2> NotFilterTenant();
