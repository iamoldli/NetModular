...
namespace NetModular.Lib.Data.Abstractions.SqlQueryable
{
        ...
        where TEntity3 : IEntity, new()
    {
        ...
        /// <returns></returns>
        INetSqlQueryable<TEntity, TEntity2, TEntity3> Where(string whereSql);
        ...
        /// <returns></returns>
        INetSqlQueryable<TEntity, TEntity2, TEntity3> WhereIf(bool condition, string whereSql);
        ...
        /// <returns></returns>
        INetSqlQueryable<TEntity, TEntity2, TEntity3> WhereIf(bool condition, string ifWhereSql, string elseWhereSql);
        ...
        /// <returns></returns>
        INetSqlQueryable<TEntity, TEntity2, TEntity3> WhereNotNull(string condition, string whereSql);
        ...
        /// <param name="elseWhereSql"></param>
        /// <returns></returns>
        INetSqlQueryable<TEntity, TEntity2, TEntity3> WhereNotNull(string condition, string ifWhereSql, string elseWhereSql);
        ...
        /// <param name="expression"></param>
        /// <returns></returns>
        INetSqlQueryable<TEntity, TEntity2, TEntity3> WhereNotNull(object condition, Expression<Func<TEntity, TEntity2, TEntity3, bool>> expression);
        ...
        /// <param name="whereSql"></param>
        /// <returns></returns>
        INetSqlQueryable<TEntity, TEntity2, TEntity3> WhereNotNull(object condition, string whereSql);
        ...
        /// <param name="elseExpression"></param>
        /// <returns></returns>
        INetSqlQueryable<TEntity, TEntity2, TEntity3> WhereNotNull(object condition, Expression<Func<TEntity, TEntity2, TEntity3, bool>> ifExpression, Expression<Func<TEntity, TEntity2, TEntity3, bool>> elseExpression);
        ...
        /// <param name="elseWhereSql"></param>
        /// <returns></returns>
        INetSqlQueryable<TEntity, TEntity2, TEntity3> WhereNotNull(object condition, string ifWhereSql, string elseWhereSql);
        ...
        /// <param name="whereSql"></param>
        /// <returns></returns>
        INetSqlQueryable<TEntity, TEntity2, TEntity3> WhereNotEmpty(Guid condition, string whereSql);
        ...
        /// <param name="elseWhereSql"></param>
        /// <returns></returns>
        INetSqlQueryable<TEntity, TEntity2, TEntity3> WhereNotEmpty(Guid condition, string ifWhereSql, string elseWhereSql);
        ...
        /// </summary>
        /// <returns></returns>
        INetSqlQueryable<TEntity, TEntity2, TEntity3> Copy();
