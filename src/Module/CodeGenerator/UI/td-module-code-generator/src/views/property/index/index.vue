<template>
  <td-list-dialog class="td-module-code-generator-property" :title=" `属性列表(${parent.name})`" icon="list" width="70%" :visible.sync="visible_" @open="onOpen">
...
<style lang="scss">
.td-module-code-generator-property {
  .icon-inherit,
  .icon-primarykey {
    font-size: 1.8em;
    cursor: pointer;
