<template>
  <td-dialog v-bind="dialog" :visible.sync="visible_" @open="onOpen">
    <el-transfer class="td-code-generator-model-property-import" v-model="value" :data="list"></el-transfer>
    <template v-slot:footer>
      <td-button type="success" text="保存" @click="submit"/>
    </template>
  </td-dialog>
</template>
<script>
...
<style lang="scss">
.td-code-generator-model-property-import {
  padding: 10px;
  height: 100%;
