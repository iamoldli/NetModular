    ...
    <nm-box-row height="100%" style="margin-bottom:20px">
            ...
            <el-row>
              <el-col :span="21" :offset="1">
                <el-form-item label="省：">
                  <nm-area-select @change="onChange1"/>
                </el-form-item>
              </el-col>
              <el-col :span="21" :offset="1">
                <el-form-item label="省市：">
                  <nm-area-select :level="1" @change="onChange1"/>
                </el-form-item>
              </el-col>
              <el-col :span="21" :offset="1">
      ...
      <nm-box-col :span="12">
        <nm-box header title="指定返回格式" icon="list">
          ...
          <nm-form ref="form1" label-width="150px">
            <el-row>
              <el-col :span="21" :offset="1">
                <el-form-item label="完整数据(all)：">
                  <nm-area-select :level="3" @change="onChange2"/>
                </el-form-item>
              </el-col>
              <el-col :span="21" :offset="1">
                <el-form-item label="编号(id)：">
                  <nm-area-select :level="3" data-type="value" @change="onChange2"/>
                </el-form-item>
              </el-col>
              <el-col :span="21" :offset="1">
                <el-form-item label="名称(name)：">
                  <nm-area-select :level="3" data-type="name" @change="onChange2"/>
                </el-form-item>
              </el-col>
              <el-col :span="21" :offset="1">
                <el-form-item label="编码(code)：">
                  <nm-area-select :level="3" data-type="code" @change="onChange2"/>
                </el-form-item>
              </el-col>
              <el-col :span="21" :offset="1">
                <el-form-item label="值：">
